...
function HpBar({hp,maxHp,color="#4fc3f7"}){
  ...
  return(
    <div style={{width:"100%"}}>
      ...
      <div style={{fontFamily:"'Orbitron',monospace",fontSize:"13px",fontWeight:700,color:"#ffffff",textAlign:"center"}}>{hp}/{maxHp} HP</div>
    </div>
  );
}
...
function BattleStage({playerDeck,aiDeck,tierInfo,onBattleEnd}){
  ...
  return(
    <div style={{display:"flex",flexDirection:"column",height:"100%",background:"#060610",overflow:"hidden"}}>
      ...
      {/* ── Combat zone ── */}
      <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"10px 16px",gap:"6px",minHeight:0}}>
        ...
        <div style={{display:"flex",justifyContent:"center"}}>
          <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:"4px"}}>
            ...
            {a.active?(
              <>
                <div style={{width:"190px","--sidebar-w":"calc(100vw - 190px)","--card-col":"1"}}>
              ...
              <div style={{width:"190px",height:"274px",border:"2px dashed #ef535033",borderRadius:"13px",display:"flex",alignItems:"center",justifyContent:"center",color:"#303050",fontFamily:"monospace",fontSize:"11px"}}>DEFEATED</div>
            )}
          </div>
        </div>

        <div style={{fontFamily:"'Orbitron',monospace",fontSize:"22px",fontWeight:900,color:"#4fc3f7",userSelect:"none",textShadow:"0 0 12px #4fc3f788",letterSpacing:"4px"}}>— VS —</div>
          ...
          <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:"4px"}}>
            ...
            {p.active?(
              <div style={{position:"relative"}}>
                ...
                {/* ── Circular attack button — absolutely right of card ── */}
              ...
              <div style={{width:"190px",height:"274px",border:"2px dashed #4fc3f733",borderRadius:"13px",display:"flex",alignItems:"center",justifyContent:"center",color:"#303050",fontFamily:"monospace",fontSize:"11px"}}>SELECT →</div>
            )}
          </div>
        </div>
      </div>
      ...
      <div style={{flexShrink:0,background:"#080818",borderTop:"1px solid #0f0f24",padding:"8px 12px 10px"}}>
        <div style={{display:"flex",alignItems:"flex-end",gap:"10px"}}>
          ...
          <div style={{flex:1,display:"flex",gap:"8px",overflowX:"auto",paddingBottom:"2px",justifyContent:"center"}}>
            {p.hand.map(card=>(
              <div key={card.id} onClick={needSelect?()=>handleSelectCard(card):undefined}
                style={{width:"100px",flexShrink:0,cursor:needSelect?"pointer":"default",borderRadius:"9px",
      ...
      {/* ── Status bar ── */}
      {(needSelect||phase==='ai_replacing'||phase==='attacking')&&(
