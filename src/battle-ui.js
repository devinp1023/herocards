    ...
    <div style={{display:"flex",flexDirection:"column",height:"100%",background:"#060610",overflow:"hidden"}}>
      ...
      <div style={{flexShrink:0,padding:"10px 16px 20px",background:"#080818",borderBottom:"1px solid #0f0f24"}}>
        ...
        <div style={{display:"flex",alignItems:"flex-end",gap:"10px"}}>
          <div style={{flex:1,display:"flex",gap:"6px",alignItems:"center",justifyContent:"center",overflowX:"auto",paddingBottom:"2px"}}>
            ...
            {a.hand.length===0&&<span style={{color:"#303050",fontFamily:"monospace",fontSize:"11px"}}>—</span>}
          </div>
          {a.deck.length>0&&(
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"10px 16px",gap:"6px",minHeight:0}}>
        ...
        <div style={{display:"flex",flexDirection:"row",alignItems:"center",gap:"12px",width:"100%",justifyContent:"center"}}>
          <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:"4px",width:"140px"}}>
